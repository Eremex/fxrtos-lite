...
if "%TOOLCHAIN%"=="IAR" (
	...
	set CC=iccarm --cpu Cortex-M33 --fpu VFPv5_sp -e --endian=little --preinclude includes.inc -I. -o
	set AS=iasmarm -s+ -r --cpu Cortex-M33 --fpu VFPv5_sp -I. -o
	set AR=iarchive --create ../libfxrtos.a
) else (
	if "%TOOLCHAIN%"=="ARM" (
		set FX_PREP=armcc -I src -E --preinclude %%s %%s
		set CC=armcc --cpu Cortex-M33 --fpu=fpv5-sp --c99 --preinclude ./includes.inc -I. -c -o
		set AS=armasm --cpu Cortex-M33 --fpu=fpv5-sp --cpreproc --cpreproc_opts=--preinclude,includes.inc -I. -o
		set AR=armar -r ../fxrtos.lib
	) else (
		set FX_PREP=%GCC_PREFIX%gcc -E -Isrc -include %%s %%s
		set CC=%GCC_PREFIX%gcc -mcpu=cortex-m33 -mfloat-abi=hard -mfpu=fpv5-sp-d16 -mthumb -pedantic -std=c99 -O2 -include includes.inc -I. -Wall -ffunction-sections -c -o
		set AS=%GCC_PREFIX%gcc -mcpu=cortex-m33 -mfloat-abi=hard -mfpu=fpv5-sp-d16 -mthumb -O2 -I. -include includes.inc -c -o
