...
if "%TOOLCHAIN%"=="IAR" (
	...
	if "%TOOLCHAIN%"=="ARM" (
		...
		set CC=%GCC_PREFIX%gcc -mcpu=cortex-m33 -mfloat-abi=soft -mthumb -pedantic -std=c99 -O2 -include includes.inc -I. -Wall -ffunction-sections -c -o
		set AS=%GCC_PREFIX%gcc -mcpu=cortex-m33 -mfloat-abi=soft -mthumb -O2 -I. -include includes.inc -c -o
